...
int main(int argc, char **argv) {
    ...
    char * fileA = "skull-icon.ppm"; //We use two files 1 which is the original image
    ...
    rotateImageDegrees(&ppm_A, &ppm_temp, 270); //Accepts only angles of 90 degrees intervals, commented for debugging 
